	...
	<div id="top-head">
		...
		<div class="social_icon">
			<ul class="clearfix">
				...
				<?php } ?>
				<?php if( get_theme_mod('connexions_lite_skype_link', '#') != '' ) { ?>
					<li class="skype-icon"><a target="_blank" href="<?php echo esc_url( get_theme_mod('connexions_lite_skype_link', '#') ); ?>"><span class="fa fa-skype" title="<?php __('skype','connexions-lite'); ?>"></span></a></li>
				<?php } ?>
				<?php if( get_theme_mod('connexions_lite_instagram_link', '#') != '' ) { ?>
					<li class="instagram-icon"><a target="_blank" href="<?php echo esc_url( get_theme_mod('connexions_lite_instagram_link', '#') ); ?>"><span class="fa fa-instagram" title="<?php __('instagram','connexions-lite'); ?>"></span></a></li>
				<?php } ?>
				<?php if( get_theme_mod('connexions_lite_vk_link', '#') != '' ) { ?>
					<li class="vk-icon"><a target="_blank" href="<?php echo esc_url( get_theme_mod('connexions_lite_vk_link', '#') ); ?>"><span class="fa fa-vk" title="<?php __('vk','connexions-lite'); ?>"></span></a></li>
				<?php } ?>
				<?php if( get_theme_mod('connexions_lite_whatsapp_link', '#') != '' ) { ?>
					<li class="whatsapp-icon"><a target="_blank" href="<?php echo esc_url( get_theme_mod('connexions_lite_whatsapp_link', '#') ); ?>"><span class="fa fa-whatsapp" title="<?php __('whatsapp','connexions-lite'); ?>"></span></a></li>
				<?php } ?>
			</ul>
		</div>
		<!-- Social Links Section -->
